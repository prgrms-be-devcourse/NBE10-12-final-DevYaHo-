...
import { BarChart3, Package, Settings, ShoppingBag, ShoppingCart, Users, Wallet } from "lucide-react";
...
// 참여 내역/내 정보는 사이드바 대신 헤더 계정 메뉴에 모아 두고, 클릭하면 내 정보·참여 내역이 같은 계정 페이지 안에서 탭으로 묶여 보이게 한다.
// 찜은 기능 미개발로 노출하지 않는다
