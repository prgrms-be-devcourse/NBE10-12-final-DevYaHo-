...
import { BarChart3, Settings, ShoppingBag, ShoppingCart } from "lucide-react";
...
// 내 정보/참여 내역 두 페이지가 공유하는 셸.
// 생산자·관리자 대시보드 사이드바를 재사용하지 않고 항상 동일한 "개인 영역"으로 보이게 하되,
// 왼쪽 사이드바로 메뉴를 두고 본문은 흰 배경(bg-wb-surface, AppShell의 sidebar 레이아웃 기본값)으로 둘러보기 화면과 구분한다.
export function AccountShell({ children }: { children: React.ReactNode }) {
  ...
  // 관리자는 소비자 활동(참여 내역)이 의미가 없으므로 내 정보만 노출
