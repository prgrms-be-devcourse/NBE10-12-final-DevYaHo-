...
public enum ErrorCode {
    ...
    DEVICE_ID_REQUIRED(HttpStatus.BAD_REQUEST, "AUTH_400_DEVICE_ID_REQUIRED", "X-Device-Id 헤더가 필요합니다."),
    ...
    CATEGORY_HAS_CHILDREN(HttpStatus.BAD_REQUEST, "CATEGORY_400_HAS_CHILDREN", "하위 카테고리가 있어 삭제할 수 없습니다."),
    CATEGORY_HAS_PRODUCTS(HttpStatus.BAD_REQUEST, "CATEGORY_400_HAS_PRODUCTS", "해당 카테고리를 사용 중인 상품이 있어 삭제할 수 없습니다."),
    PARENT_CATEGORY_NOT_FOUND(HttpStatus.BAD_REQUEST, "CATEGORY_400_PARENT_NOT_FOUND", "존재하지 않는 상위 카테고리입니다."),
    CATEGORY_DEPTH_EXCEEDED(HttpStatus.BAD_REQUEST, "CATEGORY_400_DEPTH_EXCEEDED", "카테고리는 2뎁스까지만 생성할 수 있습니다."),
    CATEGORY_NAME_DUPLICATE(HttpStatus.CONFLICT, "CATEGORY_409_NAME_DUPLICATE", "같은 위치에 동일한 이름의 카테고리가 이미 존재합니다."),
    PRODUCT_NOT_FOUND(HttpStatus.NOT_FOUND, "PRODUCT_404_NOT_FOUND", "존재하지 않는 상품입니다."),
    CANNOT_DELETE_ACTIVE_PRODUCT(HttpStatus.CONFLICT, "PRODUCT_409_CANNOT_DELETE_ACTIVE", "진행 중인 공동구매가 있어 삭제할 수 없습니다."),
    ...
    COMMON_405_METHOD_NOT_ALLOWED(HttpStatus.METHOD_NOT_ALLOWED, "COMMON_405_METHOD_NOT_ALLOWED", "허용되지 않은 요청 방식입니다."),
    COMMON_500_INTERNAL_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "COMMON_500_INTERNAL_SERVER_ERROR", "서버 내부 오류가 발생했습니다."),
    BUYER_ADDRESS_NOT_FOUND(HttpStatus.NOT_FOUND, "ADDRESS_404_NOT_FOUND", "존재하지 않는 배송지입니다."),
    BUYER_ADDRESS_FORBIDDEN(HttpStatus.FORBIDDEN, "ADDRESS_403_FORBIDDEN", "해당 배송지에 대한 권한이 없습니다.");
