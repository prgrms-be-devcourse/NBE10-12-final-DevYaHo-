...
class ProfileImageUploadServiceTest {
    ...
    void setUp() {
        ...
        profileImageUploadService = new ProfileImageUploadService(s3Presigner, "wellbuying-dev", "ap-northeast-2", "",
                300);
    }
    ...
    void 허용된_contentType이면_presigned_URL을_발급한다() throws MalformedURLException {
        ...
        ProfileImageUploadUrlResponse response = profileImageUploadService.issueUploadUrl(1L,
                new ProfileImageUploadUrlRequest("image/jpeg"));
        ...
        assertThat(response.profileImageUrl())
                .startsWith("https://wellbuying-dev.s3.ap-northeast-2.amazonaws.com/profile-images/1/")
                .endsWith(".jpg");
    }
    ...
    void 허용되지_않은_contentType이면_예외가_발생한다() {
        assertThatThrownBy(() -> profileImageUploadService.issueUploadUrl(1L,
                new ProfileImageUploadUrlRequest("image/svg+xml")))
