...
class ProductSearchServiceTest {
    ...
    void search_파라미터를_리포지토리에_위임하고_결과를_반환한다() {
        ...
        ProductSearchResponse response = new ProductSearchResponse(1L, "비타민C", "설명", 5000, "url", 0L, false, null, null, null, null, null, null, null, null, null);
        ...
        verify(productSearchRepository).search("비타민", SearchSortType.RELEVANCE, null, 20, ProductSearchFilter.none());
    }
