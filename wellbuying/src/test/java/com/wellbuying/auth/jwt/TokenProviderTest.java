...
class TokenProviderTest {
    ...
    private final TokenProvider tokenProvider =
            new TokenProvider(new JwtProperties(SECRET, 1_800_000L, 604_800_000L, 5L, true));
    ...
    void 만료된_토큰을_파싱하면_예외가_발생한다() {
        TokenProvider expiredTokenProvider = new TokenProvider(new JwtProperties(SECRET, -1000L, -1000L, 5L, true));
